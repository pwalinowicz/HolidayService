...
public class HolidayParserUtil {
    public static Optional<LocalDate> findFirstCommonDateInHolidayLists(List<Holiday> holidayList1, List<Holiday> holidayList2) {
    ...
    public static String getHolidayLocalNameByDate(List<Holiday> holidayList, LocalDate localDate) {
